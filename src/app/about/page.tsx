  ...
  return (
    <main style={{
      ...
      <div style={{ width: '100%', marginTop: '2rem' }}>
        <div style={{ position: 'relative', width: '100%', paddingBottom: '56.25%', height: 0, borderRadius: '8px', overflow: 'hidden', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.15)' }}>
          <iframe 
            src="https://www.youtube.com/embed/CbODA93ByS0" 
            title="YouTube video player"
            style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', border: 0 }}
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            referrerPolicy="strict-origin-when-cross-origin"
      ...
      <p style={{ marginTop: '2rem', fontSize: '1.2rem', textAlign: 'center' }}>
        ...
        </a> &nbsp;|&nbsp; <a href="https://github.com/fightingentropy" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.3em', textDecoration: 'none', color: 'inherit' }}>
          Github <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 120 120" style={{ display: 'block', background: '#1a232a', borderRadius: '6px', alignSelf: 'center', flexShrink: 0 }}>
            <rect width="120" height="120" fill="#1a232a"/>
            <path d="M60 20c-22.1 0-40 17.9-40 40 0 17.7 11.5 32.7 27.4 38 2-.4 2.7-.9 2.7-1.9v-6.6c-11.1 2.4-13.4-5.4-13.4-5.4-1.8-4.6-4.4-5.8-4.4-5.8-3.6-2.5.3-2.4.3-2.4 4 .3 6.1 4.1 6.1 4.1 3.5 6 9.2 4.3 11.4 3.3.4-2.6 1.4-4.3 2.5-5.3-8.7-1-17.8-4.4-17.8-19.4 0-4.3 1.5-7.8 4-10.5-.4-1-1.7-5 .4-10.4 0 0 3.3-1.1 10.8 4 3.1-.9 6.5-1.3 9.8-1.3s6.7.4 9.8 1.3c7.5-5.1 10.8-4 10.8-4 2.1 5.4.8 9.4.4 10.4 2.5 2.7 4 6.2 4 10.5 0 15.1-9.2 18.4-17.9 19.4 1.4 1.2 2.7 3.6 2.7 7.3v10.8c0 1-.7 1.5-2.7 1.9C88.5 92.7 100 77.7 100 60c0-22.1-17.9-40-40-40z" fill="#fff"/>
          </svg>
        </a>
      </p>
    </main>
